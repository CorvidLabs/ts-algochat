...
- SpecSync advisory coverage passes; all four agent integrations are installed; Trust doctor passes; TypeScript builds and all 454 Bun tests pass; existing CI
- package publication
